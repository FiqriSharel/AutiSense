...
# Toast when arriving from child selection
if st.session_state.get("child_just_selected_name"):
    child_name = st.session_state.pop("child_just_selected_name")
    st.toast(f"Now viewing **{child_name}**'s profile", icon="✅")
